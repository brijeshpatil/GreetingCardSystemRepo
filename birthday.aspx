<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="birthday, App_Web_mijwez1j" title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div style="padding-left:30px;padding-top:30px;font-size:12px;">Send hand picked, classy greeting cards to India to your loved ones. Say it with these cards across the miles.</div>
                  ...
                  <table style="padding-left:50px;">
			            <tr>
			                <td>
			                    ...
			                    <asp:SqlDataSource ID="sd" ConnectionString="<%$ ConnectionStrings:conn %>"  runat="server" SelectCommand="select * from card_master where card_type='birthday'">
			                    </asp:SqlDataSource>
