<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="feelings, App_Web_mijwez1j" title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <center><div style="padding-left:30px;padding-top:30px;font-size:14px;">Feelings Cards.</div></center>
                  ...
                  <table style="padding-left:50px;">
			            <tr>
			                <td>
			                    ...
			                    <asp:SqlDataSource ID="sd" ConnectionString="<%$ ConnectionStrings:conn %>"  runat="server" SelectCommand="select * from card_master where card_type='feeling'">
			                    </asp:SqlDataSource>
